...
#week 1 here corresponds to week 40, which ends oct 8 in 2016
...
d3$date <- d3$day +as.Date('2016-10-01')

d3b <- d3
d3b$date <- d3b$day + as.Date('2015-10-03') 

d3c <- d3
d3c$date <- d3c$day + as.Date('2017-09-30') 
